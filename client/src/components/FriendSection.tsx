...
const FriendSection = () => {
    // return (
    //     <aside className="fixed inset-y-5 left-5 z-10 flex w-[min(22rem,calc(100vw-2.5rem))] flex-col overflow-hidden rounded-[1.75rem] border border-white/10 bg-[#10131d]/95 text-slate-100 shadow-[0_28px_90px_rgba(0,0,0,0.5)] backdrop-blur-2xl">
    //         <div className="relative border-b border-white/10 bg-[linear-gradient(135deg,rgba(99,102,241,0.1),transparent,rgba(34,211,238,0.03))] px-5 pb-5 pt-6">
    //             <div className="pointer-events-none absolute -right-16 -top-20 size-40 rounded-full bg-indigo-500/20 blur-3xl" />
    ...
    //                 </div>
    //                 <button
    //                     className="grid size-10 place-items-center rounded-xl border border-indigo-300/20 bg-indigo-500/15 text-xl font-light text-indigo-200 shadow-[0_8px_24px_rgba(99,102,241,0.2)] transition hover:border-indigo-300/40 hover:bg-indigo-500/30 hover:text-white focus:outline-none focus:ring-2 focus:ring-indigo-400/60"
    //                     aria-label="Start a new message"
    //                 >
    //                     <PlusIcon />
    //                 </button>
    //             </div>
    //             <div className="mt-5 flex items-center gap-3 rounded-xl border border-white/8 bg-black/20 px-3.5 py-3 text-sm text-slate-500 shadow-inner shadow-black/10 transition focus-within:border-indigo-400/50 focus-within:bg-indigo-500/6 focus-within:text-slate-300">
    //                 <span
    //                     aria-hidden="true"
    ...
    //             <p className="px-3 pb-1 pt-1 text-[10px] font-bold uppercase tracking-[0.2em] text-slate-600">
    //                 Recent conversations
    //             </p>
    //             {friends.map((friend, index) => (
    //                 <div
    //                     key={friend.name}
    //                     className={`group flex cursor-pointer items-center gap-3 rounded-2xl border p-3 transition duration-200 ${index === 0 ? "border-indigo-300/20 bg-[linear-gradient(90deg,rgba(99,102,241,0.2),rgba(99,102,241,0.05))] shadow-lg shadow-indigo-950/20" : "border-transparent hover:border-white/8 hover:bg-white/5"}`}
    //                 >
    //                     <div className="relative shrink-0">
    //                         <div
    //                             className={`grid size-11 place-items-center rounded-full ${friend.color} text-xs font-bold text-white ring-4 ring-[#11131c] shadow-lg`}
    //                         >
    //                             {friend.initials}
    //                         </div>
    //                         {friend.online && (
    //                             <span className="absolute bottom-0 right-0 size-3 rounded-full border-2 border-[#11131c] bg-emerald-400 shadow-[0_0_8px_rgba(52,211,153,0.75)]" />
    //                         )}
    //                     </div>
    ...
    //                             </p>
    //                             {friend.unread > 0 && (
    //                                 <span className="grid size-5 shrink-0 place-items-center rounded-full bg-cyan-400 text-[10px] font-bold text-slate-950 shadow-[0_0_12px_rgba(34,211,238,0.35)]">
    //                                     {friend.unread}
    //                                 </span>
    //                             )}
    //                         </div>
    ...
    //         <div className="border-t border-white/8 px-5 py-3.5 text-[11px] font-medium tracking-wide text-slate-500">
    //             5 conversations <span className="mx-1 text-slate-700">•</span>{" "}
    //             <span className="text-emerald-400/80">3 online</span>
    //         </div>
    //     </aside>
    // );
